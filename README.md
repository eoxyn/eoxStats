Aşağıdaki kutunun sağ üst köşesinde çıkan **Kopyala (Copy)** butonuna basarsanız, tek tıkla kopyalanacaktır ve GitHub'a yapıştırdığınızda kusursuz görünecektir (önceki kopyalamanızda ufak bir kod satırı hatası olmuştu, onu da düzelttim):
